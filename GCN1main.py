...
# python GCN1main.py --data data --output_path GCN1_output\ --model MLP --epochs 3 --batch_size 24
...
def main():
    ...
    # args.output_path='/fred/oz064/wenyuzhao/ExperimentalResults/OnlineText2Melo/GCN1/'
